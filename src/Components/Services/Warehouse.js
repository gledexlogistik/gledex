    ...
    <Grid container className={classes.whiteContainer}>
        <Grid container className={classes.whiteGrid}>
            ...
            <Grid item xl={6} lg={6} md={12} xs={12} sm={12} className={classes.itemGridTxt1}>
              <h2 className={classes.headingRight}>Warehouse &<span style={{color:'#FFC700'}}> Distribution</span></h2>
              <p className={classes.textRight}>Sistem kami menyediakan pergudangan dan distribusi pusat untuk perusahaan dengan kebutuhan untuk kinerja tinggi, namun infrastruktur yang fleksibel. Melalui kemampuan logistik bersama kami, pelanggan kami mendapatkan keuntungan dari layanan yang customized. Kami menawarkan akses real-time ke status persediaan dengan menggunakan metode intuitif sederhana dalam mengelola inventaris Anda. Negara kita dari sistem seni termasuk barcode scanning, label kepatuhan, optimalisasi ruang dan layanan dukungan nilai tambah.</p>
            </Grid>
            <Grid item xl={12} lg={12} md={12} xs={12} sm={12} className={classes.itemGridTxt2}>
                <p className={classes.textRight}>Kami menawarkan berbagai pergudangan, distribusi, dan layanan bernilai tambah yang dirancang untuk mempercepat rantai suplai Anda secara efisien dan efektif biaya mungkin. Dengan memanfaatkan efisiensi dan pengalaman kami untuk mengurangi total biaya Pergudangan dan Distribusi, perusahaan Anda dapat memfokuskan waktu dan uang pada apa yang benar-benar penting dalam industri Anda daripada membuang-buang sumber daya berharga pada logistik. Layanan kami di wilayah ini, termasuk :</p>
